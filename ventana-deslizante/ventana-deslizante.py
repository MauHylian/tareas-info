...
def lz77(textFile, windowBits, lengthBits):
    ...
    print("Longitud de los datos: {} bits".format(len(data)))
    print("Longitud comprimida: {} bits".format(len(compressed)))
    
    if (data == decompressed):
        print("Compresión y decompresión exitosa")
    else:
        print("Error y en compresión y decompresión")
